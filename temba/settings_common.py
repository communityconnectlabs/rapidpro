...
# REDIS_TLS_SKIP_VERIFY=1 is a convenience alias (matching courier/mailroom) that forces "none".
...
if os.environ.get("REDIS_TLS_SKIP_VERIFY", "").lower() in ("1", "true", "yes"):
    REDIS_SSL_CERT_REQS = "none"

# redis-py 4.6 defaults ssl_check_hostname to False; verify the hostname whenever we verify the cert.
REDIS_SSL_CHECK_HOSTNAME = REDIS_USE_TLS and REDIS_SSL_CERT_REQS != "none"
...
if REDIS_USE_TLS:
    ...
    CELERY_BROKER_USE_SSL = {
        "ssl_cert_reqs": _CERT_REQS.get(REDIS_SSL_CERT_REQS, _ssl.CERT_REQUIRED),
        "ssl_check_hostname": REDIS_SSL_CHECK_HOSTNAME,
    }
...
SOCIAL_AUTH_AZUREAD_OAUTH2_KEY = os.environ.get("MS_CLIENT_ID")
SOCIAL_AUTH_AZUREAD_OAUTH2_SECRET = os.environ.get("MS_CLIENT_SECRET")
SOCIAL_AUTH_AZUREAD_OAUTH2_RESOURCE = "https://graph.microsoft.com/"
SOCIAL_AUTH_AZUREAD_SCOPE = ["openid", "email", "profile"]
...
SOCIAL_AUTH_PIPELINE = (
    ...
    "temba.utils.pipeline.require_pre_registered_user",
    "temba.utils.pipeline.associate_by_email",
...
SOCIAL_AUTH_AZUREAD_OAUTH2_AUTH_EXTRA_ARGUMENTS = {"prompt": "select_account"}  # Forces account selection
